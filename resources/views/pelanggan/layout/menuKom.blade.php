            ...
            <div class="row">
                <div class="col-xl-3 col-lg-3">
                    <div class="logo mt-40">
                        <a href="index.html"><img src="{{ asset('pelangganTools/images/logo/logo-1.png') }}" alt="logo"></a>
                    </div>
                </div>
                                ...
                                <ul>
                                    <li class="single-shopping-cart">
                                        <div class="shopping-cart-img">
                                            <a href="#"><img alt="" src="{{ asset('pelangganTools/images/cart/cart-1.jpg') }}"></a>
                                    ...
                                    <li class="single-shopping-cart">
                                        <div class="shopping-cart-img">
                                            <a href="#"><img alt="" src="{{ asset('pelangganTools/images/cart/cart-2.jpg') }}"></a>
                                            <div class="item-close">
                                                <a href="#"><i class="sli sli-close"></i></a>
                                            </div>
                                        </div>
                                    ...
                                    <li class="single-shopping-cart">
                                        <div class="shopping-cart-img">
                                            <a href="#"><img alt="" src="{{ asset('pelangganTools/images/cart/cart-3.jpg') }}"></a>
                                            <div class="item-close">
                                                <a href="#"><i class="sli sli-close"></i></a>
                                            </div>
                                        </div>
