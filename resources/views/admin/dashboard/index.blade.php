...
@section('css')
    <link href="{{ asset('adminTools/plugins/jvectormap/jquery-jvectormap-2.0.2.css') }}" rel="stylesheet">
    <link href="{{ asset('adminTools/plugins/lightpick/lightpick.css') }}" rel="stylesheet" />
@endsection
        ...
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-8">
                        <div class="media">
                            <img src="{{ asset('adminTools/assets/images/logo-sm.png') }}" height="40" class="mr-4 align-self-center" alt="...">
                ...
                <div class="table-responsive">
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <img class="" src="{{ asset('adminTools/assets/images/products/img-1.png') }}" alt="user"> </td>
                                <td>
                                    Beg
                                </td>
                                <td>                                                                
                                    <img src="{{ asset('adminTools/assets/images/flags/us_flag.jpg') }}" alt="" class="img-flag thumb-xxs rounded-circle">
                                </td>
                            ...
                            <tr>
                                <td>
                                    <img class="" src="{{ asset('adminTools/assets/images/products/img-2.png') }}" alt="user"> </td>
                                <td>
                                    Watch
                                </td>
                                <td>                                                                
                                    <img src="{{ asset('adminTools/assets/images/flags/french_flag.jpg') }}" alt="" class="img-flag thumb-xxs rounded-circle">
                                </td>
                            ...
                            <tr>
                                <td>
                                    <img class="" src="{{ asset('adminTools/assets/images/products/img-3.png') }}" alt="user"> </td>
                                <td>
                                    Headphone
                                </td>
                                <td>                                                                
                                    <img src="{{ asset('adminTools/assets/images/flags/spain_flag.jpg') }}" alt="" class="img-flag thumb-xxs rounded-circle">
                                </td>
                            ...
                            <tr>
                                <td>
                                    <img class="" src="{{ asset('adminTools/assets/images/products/img-4.png') }}" alt="user"> </td>
                                <td>
                                    Purse
                                </td>
                                <td>                                                                
                                    <img src="{{ asset('adminTools/assets/images/flags/russia_flag.jpg') }}" alt="" class="img-flag thumb-xxs rounded-circle">
                                </td>
                            ...
                            <tr>
                                <td>
                                    <img class="" src="{{ asset('adminTools/assets/images/products/img-5.png') }}" alt="user"> </td>
                                <td>
                                    Shoe
                                </td>
                                <td>                                                                
                                    <img src="{{ asset('adminTools/assets/images/flags/italy_flag.jpg') }}" alt="" class="img-flag thumb-xxs rounded-circle">
                                </td>
                        ...
                        <tbody>
                            <tr>
                                <td class="border-top-0">
                                    <div class="media">
                                        <img src="{{ asset('adminTools/assets/images/products/img-7.png') }}" height="80" class="mr-4" alt="...">
                                        <div class="media-body align-self-center"> 
                            ...
                            <tr>
                                <td>
                                    <div class="media">
                                        <img src="{{ asset('adminTools/assets/images/products/img-3.png') }}" height="80" class="mr-4" alt="...">
                                        <div class="media-body align-self-center"> 
                            ...
                            <tr>
                                <td>
                                    <div class="media">
                                        <img src="{{ asset('adminTools/assets/images/products/img-1.png') }}" height="80" class="mr-4" alt="...">
                                        <div class="media-body align-self-center"> 
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="d-flex justify-content-between p-3 bg-light">
                    <div class="media">
                        <img src="{{ asset('adminTools/assets/images/users/user-2.jpg') }}" class="mr-3 thumb-md rounded-circle" alt="...">
                        <div class="media-body align-self-center">                                                           
                    ...
                    <ul class="nav nav-pills justify-content-center text-center mb-3" id="pills-tab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="pills-credit-card-tab" data-toggle="pill" href="#pills-credit-card">
                                <img src="{{ asset('adminTools/assets/images/cards/card-1.png') }}" alt=""  class="img-fluid">
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="pills-paypal-tab" data-toggle="pill" href="#pills-paypal">
                                <img src="{{ asset('adminTools/assets/images/cards/card-2.png') }}" alt=""  class="img-fluid">
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="pills-bitcoin-tab" data-toggle="pill" href="#pills-bitcoin">
                                <img src="{{ asset('adminTools/assets/images/cards/card-3.png') }}" alt=""  class="img-fluid">
                            </a>
                        </li>
                    </ul>
...
<script src="{{ asset('adminTools/plugins/apexcharts/apexcharts.min.js') }}"></script>
<script src="{{ asset('adminTools/plugins/jvectormap/jquery-jvectormap-2.0.2.min.js') }}"></script>
<script src="{{ asset('adminTools/plugins/jvectormap/jquery-jvectormap-world-mill-en.js') }}"></script>
<script src="{{ asset('adminTools/plugins/chartjs/chart.min.js') }}"></script>
<script src="{{ asset('adminTools/plugins/chartjs/roundedBar.min.js') }}"></script>
<script src="{{ asset('adminTools/plugins/lightpick/lightpick.js') }}"></script>
<script src="{{ asset('adminTools/assets/pages/jquery.sales_dashboard.init.js') }}"></script>
@endsection